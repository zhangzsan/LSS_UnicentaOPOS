    ...
    private String getProductLabel(ProductInfoExt product) {
        ...
        if (pricevisible) {
            if (taxesincluded) {
                ...
                return "<html><div style=\"width: 100%; word-break: break-word;white-space: normal;\"><b>" + product.getName() + "</div><br>" + product.printPriceSellTax(tax);
            } else {
                return "<html><div style=\"width: 100%; word-break: break-word;white-space: normal;\"><b>" + product.getName() + "</div><br>" + product.printPriceSell();
