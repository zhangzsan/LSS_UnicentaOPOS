...
public class PaymentsModel {
    ...
    private java.util.List<DrawerLine> m_ldrawer;
...
// end     
    ...
    private double m_totalBankDeposit = 0.00;

    private PaymentsModel() {
    }

    public void setDrawerList(List<DrawerLine> list)
    {
        m_ldrawer = list;
    }
    
    public void setVarianceAmt(double var)
    {
        variance = var;
    }
    
    public void setDepositAmt(double amt)
    {
        m_totalBankDeposit = amt;
    }
...
// JG 16 May 2013 use diamond inference
    ...
    public List<DrawerLine> getDrawerLines(){
        return m_ldrawer;
    }
    /**
     *
...
// JG 9 Nov 12
    ...
    public List<CategorySalesLine> getCategorySalesLines() {
        return m_lcategorysales;
            ...
            public static class DrawerLine implements SerializableRead {
        ...
        public void readValues(DataRead dr) throws BasicException {
            m_Type = dr.getString(1);
            m_Amount = dr.getString(2);
            m_Total = dr.getInt(3);
        }
        
        public DrawerLine(String a, String b, int c){
            m_Type = a;
            m_Amount = b;
            m_Total = c;
        }
