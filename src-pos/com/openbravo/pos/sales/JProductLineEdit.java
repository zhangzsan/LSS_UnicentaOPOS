...
public class JProductLineEdit extends javax.swing.JDialog {
    ...
    private TicketLineInfo init(AppView app, TicketLineInfo oLine, List<TaxInfo> taxlist) throws BasicException {
...
//        m_jName.setText(m_oLine.getProperty("product.name"));
     ...
     */
    public static TicketLineInfo showMessage(Component parent, AppView app, TicketLineInfo oLine, List<TaxInfo> taxes) throws BasicException {
        ...
        return myMsg.init(app, oLine, taxes);
    }        
